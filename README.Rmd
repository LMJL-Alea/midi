...
voxel. The [**midi**](https://astamm.github.io/midi/) package is meant to list
the tissue models that have been proposed in the literature and to provide tools
to simulate the MR signal attenuation predicted by these models under different
...
A 3D visualization of the cylinder bundle can be obtained powered by the **rgl**
package is also available through an S3 specialization of the `rgl::plot3d()`
function.
