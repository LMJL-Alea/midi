...
[![Codecov test coverage](https://codecov.io/gh/lmjl-alea/midi/branch/main/graph/badge.svg)](https://app.codecov.io/gh/lmjl-alea/midi?branch=main)
...
cylinder axis, radius and diffusivity, which are only the parameters related to
the cylinder geometry. The radius and diffusivity are in fact the parameters of
the restricted compartment, which is first instantiated and then passed to the
cylinder compartment. Several other restricted compartments are available in the
package.

Once instantiated, the compartment object can be used to access the list of its
parameters:
...
`plot3d()`. See the documentation online at <https://lmjl-alea.github.io/midi/reference/plot3d.html> for more details.
