...
The goal of midi is to provide tools for simulating MR signal attenuations induced by diffusion of water in biological tissues. The package is based on the theory of diffusion MRI and provides functions for simulating the signal attenuation in pulse-gradient spin-echo MR sequences for different tissue models.
